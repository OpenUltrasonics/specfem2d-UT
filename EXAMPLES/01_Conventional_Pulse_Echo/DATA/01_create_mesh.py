...
# Calculate optimal base mesh size (lc) from Physics
...
# =====================================================================
# 3. REGEX UPDATE OF THE .GEO FILE
# =====================================================================
with geo_source.open('r') as file:
    geo_data = file.read()

# Find the line starting with "lc =" and replace it with the new calculated value
geo_data = re.sub(r'^lc\s*=.*;', f'lc = {mesh_size:.6f};', geo_data, flags=re.MULTILINE)
